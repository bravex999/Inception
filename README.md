...
6. Stop: `make down` — Full clean: `make clean`
...
- [OpenSSL docs](https://www.openssl.org/docs/) — Self-signed certificate generation with req command

## AI Usage

The AI  was used as a learning and productivity tool throughout this project:

- **Concept explanations:** PID 1 in Docker, idempotent initialization, TLS handshake, bridge networks, named volumes, FastCGI protocol, DNS resolution in containers, bootstrap mode in MariaDB, etc.
- **Script structuring:** entrypoint scripts explanations.
